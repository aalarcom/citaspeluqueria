...
public class LoginConnection extends AsyncTask {
    private String username;
    private String password;
    private OnTaskCompleted listener;

    public LoginConnection(String username, String password, OnTaskCompleted listener){
    ...
    protected Object doInBackground(Object[]objects){
        ...
        try{
            String url="http://10.164.200.208:8080/APP/webresources/prueba";
            URL obj = new URL(url);
